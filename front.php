...
<head>
    ...
    <link rel="stylesheet" href="./views/css/bigvideo.css">
    <script src="./views/js/modernizr-2.5.3.min.js"></script>
    <!--[if lte IE 8]>
    <style>
...
<body>
    ...
    <script src="./views/js/jquery-ui-1.8.22.custom.min.js"></script>
    <script src="./views/js/jquery.imagesloaded.min.js"></script>
    <script src="http://vjs.zencdn.net/c/video.js"></script>

    <!-- BigVideo -->
    <script src="./views/js/bigvideo.js"></script>

    <!-- Tutorial Demo -->
    <script src="./views/js/jquery.transit.min.js"></script>
    <script>
        $(function() {
